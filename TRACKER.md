...
- **Idea capture** → a pitched or discovered idea, out of scope for the current slice, appends **one line** to `IDEAS.md`. Zero-friction and pre-triage: no brief, no evidence, no score — just the line — and never derail the task to build it.
...
```markdown
- <one-line want> — _pitched|discovered · effort: <slug> · 2026-07-12_
```
...
```markdown
- <one-line want> — _pitched · effort: <slug> · 2026-07-12_
