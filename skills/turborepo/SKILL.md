...
<!-- vendored verbatim from `vercel/turborepo` main:skills/turborepo (MIT; LICENSE kept).
     ...
     not installed via a plugin, so vendored like react-router. kept verbatim.
     re-sync: re-download SKILL.md + command/ + references/ from
     raw.githubusercontent.com/vercel/turborepo/main/skills/turborepo/. symlinked at ~/.claude/skills/turborepo. -->
