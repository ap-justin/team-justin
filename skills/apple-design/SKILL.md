...
<!-- vendored from `emilkowalski/skills` (main, sha 6bf2443) → `skills/apple-design`.
     ...
     Kept verbatim; re-sync: re-download from https://raw.githubusercontent.com/emilkowalski/skills/main/skills/apple-design/. -->
