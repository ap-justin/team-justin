...
- Remove its row from `${CLAUDE_PLUGIN_ROOT}/references/routing.md`, or its review wiring (Step 4). A deployed repo still naming it in its sheet sheds the line on its next `/kru:setup`.
